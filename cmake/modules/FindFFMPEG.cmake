...
if(WITH_FFMPEG)
  ...
  set(_libavcodec_ver "60.2.100")
  set(_libavfilter_ver "9.3.100")
  set(_libavformat_ver "60.3.100")
  set(_libavutil_ver "58.2.100")
  set(_libpostproc_ver "57.1.100")
  set(_libswresample_ver "4.10.100")
  set(_libswscale_ver "7.1.100")
endif()
...
if(ENABLE_INTERNAL_FFMPEG)
  ...
  set(FFMPEG_PKGS libavcodec>=${_libavcodec_ver}
                  libavfilter>=${_libavfilter_ver}
                  libavformat>=${_libavformat_ver}
                  libavutil>=${_libavutil_ver}
                  libswscale>=${_libswscale_ver}
                  libswresample>=${_libswresample_ver}
                  libpostproc>=${_libpostproc_ver})
  ...
  if((PC_FFMPEG_FOUND
    ...
    ffmpeg_find_lib(libavcodec)
    ffmpeg_find_lib(libavfilter)
    ffmpeg_find_lib(libavformat)
    ffmpeg_find_lib(libavutil)
    ffmpeg_find_lib(libswscale)
    ffmpeg_find_lib(libswresample)
    ffmpeg_find_lib(libpostproc)
    ...
    macro(ffmpeg_create_target libname)
      ...
      if(PKG_CONFIG_FOUND AND NOT WIN32)
        ...
        pkg_check_modules(PC_FFMPEG_${libname} ${libname}>=${_${libname}_ver} QUIET)
    ...
    ffmpeg_create_target(libavcodec)
    ffmpeg_create_target(libavfilter)
    ffmpeg_create_target(libavformat)
    ffmpeg_create_target(libavutil)
    ffmpeg_create_target(libswscale)
    ffmpeg_create_target(libswresample)
