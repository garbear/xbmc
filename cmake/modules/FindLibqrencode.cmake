...
if(NOT TARGET libqrencode::libqrencode)
  if(ENABLE_INTERNAL_LIBQRENCODE)
    ...
    find_path(LIBQRENCODE_LIBRARY_RELEASE NAMES qrencode)
    find_path(LIBQRENCODE_LIBRARY_DEBUG NAMES qrencoded)
  endif()
  ...
  if(LIBQRENCODE_FOUND)
    ...
    if(LIBQRENCODE_LIBRARY_RELEASE)
      set_target_properties(libqrencode::libqrencode PROPERTIES
        ...
        IMPORTED_LOCATION "${LIBQRENCODE_LIBRARY_RELEASE}")
    endif()
    if(LIBQRENCODE_LIBRARY_DEBUG)
      set_target_properties(libqrencode::libqrencode PROPERTIES
        IMPORTED_CONFIGURATIONS DEBUG
        IMPORTED_LOCATION "${LIBQRENCODE_LIBRARY_DEBUG}")
    endif()
