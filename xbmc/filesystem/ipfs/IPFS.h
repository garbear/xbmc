...
public:
  ...
  std::string PutDAG(
      ...
      KODI::DATASTORE::CIDCodec codec = KODI::DATASTORE::CIDCodec::DAG_JSON) override;
  ...
  bool IsDirectory(const std::string& cid) override;
  bool ListDirectory(const std::string& cid, std::vector<CIPFSEntry>& entries) override;
