...
std::vector<std::shared_ptr<const KEYMAP::IWindowKeymap>> CJoystickMapper::GetJoystickKeymaps() const
{
  std::vector<std::shared_ptr<const KEYMAP::IWindowKeymap>> keymaps;
