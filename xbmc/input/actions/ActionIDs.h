...
constexpr const int ACTION_JUMP_SMS2 =
...
constexpr const int ACTION_TELETEXT_RED =
    215; //!< Teletext Color button <b>Red</b> to control TopText
constexpr const int ACTION_TELETEXT_GREEN =
    216; //!< Teletext Color button <b>Green</b> to control TopText
constexpr const int ACTION_TELETEXT_YELLOW =
    217; //!< Teletext Color button <b>Yellow</b> to control TopText
constexpr const int ACTION_TELETEXT_BLUE =
    218; //!< Teletext Color button <b>Blue</b> to control TopText
...
constexpr const int ACTION_PLAYER_PLAYPAUSE =
...
constexpr const int ACTION_BROWSE_SUBTITLE =
...
constexpr const int ACTION_VIDEO_NEXT_STREAM =
