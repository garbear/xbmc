...
private:
   ...
   */
  static bool IsValidKeyHeader(const std::string& multibaseKey, CMulticodec::Code expectedCode);
   ...
   */
  static std::string EncodeMultibaseKey(CMulticodec::Code code, const std::vector<uint8_t>& key);
