...
public:
   ...
   *
   * Official values below match the upstream table.csv. DAG_FLATBUFFER and
   * DAG_JSON_LZ4 are local application codecs and should remain local until
   * upstream multicodec codes are allocated.
   */
