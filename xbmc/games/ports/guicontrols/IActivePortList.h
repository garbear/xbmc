 ...
 *
 * Ports are represented by the controller icon of the connected controller.
 *
...
public:
  ...
  /*!
   * \brief Get the controllers connected to the input ports
   */
  virtual ControllerVector GetControllers() = 0;
};
