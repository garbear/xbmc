...
public:
    ...
    JOYSTICK::FEATURE_TYPE GetFeatureType(const JOYSTICK::FeatureName& feature) override { return JOYSTICK::FEATURE_TYPE::UNKNOWN;}
    bool GetScalar(const JOYSTICK::FeatureName& feature,                   JOYSTICK::CDriverPrimitive& primitive) override { return false; }
    void AddScalar(const JOYSTICK::FeatureName& feature,                   const JOYSTICK::CDriverPrimitive& primitive) override { }
    bool GetAnalogStick(const JOYSTICK::FeatureName& feature,                        JOYSTICK::ANALOG_STICK_DIRECTION direction,                        JOYSTICK::CDriverPrimitive& primitive) override { return false; }
    ...
    bool GetRelativePointer(const JOYSTICK::FeatureName& feature,                            JOYSTICK::RELATIVE_POINTER_DIRECTION direction,                            JOYSTICK::CDriverPrimitive& primitive) override { return false; }
    ...
    bool GetAccelerometer(const JOYSTICK::FeatureName& feature,                          JOYSTICK::CDriverPrimitive& positiveX,                          JOYSTICK::CDriverPrimitive& positiveY,                          JOYSTICK::CDriverPrimitive& positiveZ) override { return false; }
    ...
    bool GetWheel(const JOYSTICK::FeatureName& feature,                  JOYSTICK::WHEEL_DIRECTION direction,                  JOYSTICK::CDriverPrimitive& primitive) override { return false; }
  void AddWheel(const JOYSTICK::FeatureName& feature,                  JOYSTICK::WHEEL_DIRECTION direction,                  const JOYSTICK::CDriverPrimitive& primitive) override { }
    bool GetThrottle(const JOYSTICK::FeatureName& feature,                     JOYSTICK::THROTTLE_DIRECTION direction,                     JOYSTICK::CDriverPrimitive& primitive) override { return false; }
    ...
    bool GetKey(const JOYSTICK::FeatureName& feature,                JOYSTICK::CDriverPrimitive& primitive) override { return false; }
    ...
    bool GetAxisProperties(unsigned int axisIndex, int& center, unsigned int& range) override { return false; }
