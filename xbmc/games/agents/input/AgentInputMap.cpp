...
namespace
{
constexpr const char* PORT_XML_FILE = "inputmap.xml";
...
CAgentInputMap::CAgentInputMap() = default;

CAgentInputMap::~CAgentInputMap() = default;

void CAgentInputMap::Initialize(const std::string& profilePath)
{
  m_xmlPath = URIUtils::AddFileToFolder(profilePath, PORT_XML_FILE);
}

void CAgentInputMap::Deinitialize()
{
  // Wait for save tasks
...
/*
void CAgentInputMap::SetControllerTree(const CControllerTree& controllerTree)
{
  m_controllerTree = controllerTree;
}
*/

void CAgentInputMap::LoadXML()
{
...
void CAgentInputMap::ConnectController(const std::string& portAddress,
                                       bool connected,
...
bool CAgentInputMap::ConnectController(const std::string& portAddress,
                                       bool connected,
                                       const std::string& controllerId,
                                       PortVec& ports)
{
...
void CAgentInputMap::DeserializePorts(const tinyxml2::XMLElement* pElement, PortVec& ports)
{
...
void CAgentInputMap::DeserializePort(const tinyxml2::XMLElement* pPort, CPortNode& port)
{
  // Connected
...
void CAgentInputMap::DeserializeControllers(const tinyxml2::XMLElement* pPort,
                                            ControllerNodeVec& controllers)
{
...
void CAgentInputMap::DeserializeController(const tinyxml2::XMLElement* pController,
                                           CControllerNode& controller)
{
  // Child ports
...
void CAgentInputMap::SerializePorts(tinyxml2::XMLElement& node, const PortVec& ports)
{
...
void CAgentInputMap::SerializePort(tinyxml2::XMLElement& portNode, const CPortNode& port)
{
  // Port ID
...
void CAgentInputMap::SerializeControllers(tinyxml2::XMLElement& portNode,
...
void CAgentInputMap::SerializeController(tinyxml2::XMLElement& controllerNode,
...
bool CAgentInputMap::HasState(const CPortNode& port)
{
  // Ports have state (is connected / active controller)
  return true;
}

bool CAgentInputMap::HasState(const CControllerNode& controller)
{
