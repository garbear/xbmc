    ...
    m_region(GAME_REGION_UNKNOWN)
{
  ...
  ParseLibretroName(Name(), m_emulatorName, m_platforms);
}
...
void CGameClient::ParseLibretroName(const std::string& addonName, std::string& emulatorName, std::string& platforms)
{
