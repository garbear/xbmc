...
public:
  ...
  ///
  /// @param[in] callback Callback invoked once per triggered achievement. It
  ///                     may be called zero or more times for a single call.
  ///                     The URL string reference is valid only for the
  ///                     callback invocation and must be copied if needed
  ///                     afterwards.
  ///
  /// @return The error, or @ref GAME_ERROR_NO_ERROR if the call was successful
  ///
