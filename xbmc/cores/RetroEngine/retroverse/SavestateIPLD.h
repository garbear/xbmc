...
class CSavestateIPLD : public ISavestate
{
public:
  CSavestateIPLD();
  ~CSavestateIPLD() override;
...
private:
   ...
   */
  //std::unique_ptr<flatbuffers::FlatBufferBuilder> m_builder; //! @todo
  ...
  using StringOffset = size_t; // flatbuffers::Offset<flatbuffers::String>;
  using VectorOffset = size_t; // flatbuffers::Offset<flatbuffers::Vector<uint8_t>>;
