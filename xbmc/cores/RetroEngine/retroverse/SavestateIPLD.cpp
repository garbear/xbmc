...
CSavestateIPLD::CSavestateIPLD()
{
  Reset();
}

CSavestateIPLD::~CSavestateIPLD() = default;

void CSavestateIPLD::Reset()
{
...
bool CSavestateIPLD::Serialize(const uint8_t*& data, size_t& size) const
{
...
SAVE_TYPE CSavestateIPLD::Type() const
{
...
void CSavestateIPLD::SetType(SAVE_TYPE type)
{
  m_type = type;
}

uint8_t CSavestateIPLD::Slot() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetSlot(uint8_t slot)
{
  m_slot = slot;
}

std::string CSavestateIPLD::Label() const
{
  std::string label;
...
void CSavestateIPLD::SetLabel(const std::string& label)
{
  m_labelOffset = std::make_unique<StringOffset>(m_builder->CreateString(label));
}

std::string CSavestateIPLD::Caption() const
{
  std::string caption;
...
void CSavestateIPLD::SetCaption(const std::string& caption)
{
  m_captionOffset = std::make_unique<StringOffset>(m_builder->CreateString(caption));
}

CDateTime CSavestateIPLD::Created() const
{
...
void CSavestateIPLD::SetCreated(const CDateTime& createdUTC)
{
  m_createdOffset =
      std::make_unique<StringOffset>(m_builder->CreateString(createdUTC.GetAsW3CDateTime(true)));
}

std::string CSavestateIPLD::GameFileName() const
{
...
void CSavestateIPLD::SetGameFileName(const std::string& gameFileName)
{
  m_gameFileNameOffset = std::make_unique<StringOffset>(m_builder->CreateString(gameFileName));
}

uint64_t CSavestateIPLD::TimestampFrames() const
{
  return m_savestate->timestamp_frames();
}

void CSavestateIPLD::SetTimestampFrames(uint64_t timestampFrames)
{
  m_timestampFrames = timestampFrames;
}

double CSavestateIPLD::TimestampWallClock() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetTimestampWallClock(double timestampWallClock)
{
  m_timestampWallClock = timestampWallClock;
}

std::string CSavestateIPLD::GameClientID() const
{
...
void CSavestateIPLD::SetGameClientID(const std::string& gameClientId)
{
  m_emulatorAddonIdOffset = std::make_unique<StringOffset>(m_builder->CreateString(gameClientId));
}

std::string CSavestateIPLD::GameClientVersion() const
{
...
void CSavestateIPLD::SetGameClientVersion(const std::string& gameClientVersion)
{
  m_emulatorVersionOffset =
      std::make_unique<StringOffset>(m_builder->CreateString(gameClientVersion));
}

AVPixelFormat CSavestateIPLD::GetPixelFormat() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetPixelFormat(AVPixelFormat pixelFormat)
{
  m_pixelFormat = pixelFormat;
}

unsigned int CSavestateIPLD::GetNominalWidth() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetNominalWidth(unsigned int nominalWidth)
{
  m_nominalWidth = nominalWidth;
}

unsigned int CSavestateIPLD::GetNominalHeight() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetNominalHeight(unsigned int nominalHeight)
{
  m_nominalHeight = nominalHeight;
}

unsigned int CSavestateIPLD::GetMaxWidth() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetMaxWidth(unsigned int maxWidth)
{
  m_maxWidth = maxWidth;
}

unsigned int CSavestateIPLD::GetMaxHeight() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetMaxHeight(unsigned int maxHeight)
{
  m_maxHeight = maxHeight;
}

float CSavestateIPLD::GetPixelAspectRatio() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetPixelAspectRatio(float pixelAspectRatio)
{
  m_pixelAspectRatio = pixelAspectRatio;
}

const uint8_t* CSavestateIPLD::GetVideoData() const
{
...
size_t CSavestateIPLD::GetVideoSize() const
{
  if (m_savestate != nullptr && m_savestate->video_data())
...
uint8_t* CSavestateIPLD::GetVideoBuffer(size_t size)
{
...
unsigned int CSavestateIPLD::GetVideoWidth() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetVideoWidth(unsigned int videoWidth)
{
  m_videoWidth = videoWidth;
}

unsigned int CSavestateIPLD::GetVideoHeight() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetVideoHeight(unsigned int videoHeight)
{
  m_videoHeight = videoHeight;
}

unsigned int CSavestateIPLD::GetRotationDegCCW() const
{
  if (m_savestate != nullptr)
...
void CSavestateIPLD::SetRotationDegCCW(unsigned int rotationCCW)
{
  m_rotationCCW = rotationCCW;
}

const uint8_t* CSavestateIPLD::GetMemoryData() const
{
...
size_t CSavestateIPLD::GetMemorySize() const
{
  if (m_savestate != nullptr && m_savestate->memory_data())
...
uint8_t* CSavestateIPLD::GetMemoryBuffer(size_t size)
{
...
bool CSavestateIPLD::Deserialize(std::vector<uint8_t> data)
{
