...
public:
  ...
  unsigned int CPUUtilization() const override { return m_cpuUtilization; }
  unsigned int MemoryUtilization() const override { return m_memoryUtilization; }
...
private:
  ...
  unsigned int m_cpuUtilization{0};
  unsigned int m_memoryUtilization{0};
