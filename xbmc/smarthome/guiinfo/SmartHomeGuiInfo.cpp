                                 ...
                                 std::string* fallback) const
{
  switch (info.m_info)
  {
    ...
    {
      value = StringUtils::Format("{} %", m_stationHud.CPUUtilization());
      return true;
    }
    ...
    {
      value = StringUtils::Format("{} %", m_trainHud.CPUUtilization());
      return true;
    }
    case SMARTHOME_TRAIN_MEMORY:
    {
      value = StringUtils::Format("{} %", m_trainHud.MemoryUtilization());
      return true;
    }
